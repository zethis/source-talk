...
- Dé�finition et fonctionnement.
- Avantages et inconvénients.

## 3. Explication des serveurs 128-ticks (4 minutes)
- Définition t fonctionnement.
...
- Pourquoi Valve a décidé de ne pas utiser les serveurs 128-ticks.
- Réaction de la communauté et nséquences sur la scène compétitive.

## 5. Présentation de la technologie subtick dans Source 2, pourquoi c'est g�nial et nul a la fois ? (4 minutes)
...
- interpolation
- commande cl_interp et pourquoi valve la supprimé (elle permettais de changer la valeur coté client, mais pas asser fair pour tout le monde, car tout le monde n'a pas un super ordi ET une superbe connexion)
- picker avantage, le temps ou tu pick et le moment ou l'enmeni voit le pick

## 6. Conclusion (2 minutes)
- doubler les couts pour resoudre un probl�me technique n'est pas �l�guant mais resoud les soucis
- compromis ?
